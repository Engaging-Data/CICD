CREATE TABLE "load_countrycodes_file_sources"
(
    "name" varchar(64)
    , "alpha_2" varchar(4)
    , "alpha_3" varchar(4)
...
COMMENT ON COLUMN "load_countrycodes_file_sources"."dss_record_source"
IS 'Record source';

COMMENT ON COLUMN "load_countrycodes_file_sources"."dss_load_date"

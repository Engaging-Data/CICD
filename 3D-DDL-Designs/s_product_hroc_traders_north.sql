CREATE TABLE "s_product_hroc_traders_north"
(
...
COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_change_hash"
IS 'The changing hash';

COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_record_source"
IS 'Record source';

COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_load_date"
IS 'Date and time the row was loaded in the data vault';

COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_start_date"
IS 'Date and time the row started in the data vault';

COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_version"
IS 'Version number of a business key in the data vault';

COMMENT ON COLUMN "s_product_hroc_traders_north"."dss_create_time"

CREATE TABLE "stage_orders_shippers_employees_customers_traders_north"
(
...
COMMENT ON COLUMN "stage_orders_shippers_employees_customers_traders_north"."dss_record_source"
IS 'Record source';

COMMENT ON COLUMN "stage_orders_shippers_employees_customers_traders_north"."dss_load_date"
IS 'Date and time the row was loaded in the data vault';

COMMENT ON COLUMN "stage_orders_shippers_employees_customers_traders_north"."dss_create_time"

CREATE TABLE "stage_products_categories_suppliers_traders_south"
(
...
COMMENT ON COLUMN "stage_products_categories_suppliers_traders_south"."dss_record_source"
IS 'Record source';

COMMENT ON COLUMN "stage_products_categories_suppliers_traders_south"."dss_load_date"
IS 'Date and time the row was loaded in the data vault';

COMMENT ON COLUMN "stage_products_categories_suppliers_traders_south"."dss_create_time"
